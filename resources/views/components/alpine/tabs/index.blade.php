    ...
    >
        ...
        <li>
            <button
                ...
                class="inline-flex rounded-t-md border-l border-r border-t px-5 py-2.5"
                role="tab"
            >
                Tab 1
            </button>
    ...
    <div role="tabpanels" class="rounded-b-md border border-gray-200 bg-white">
        ...
        >
            ...
            <p class="mt-2 text-gray-500">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Optio, quo sequi error quibusdam quas
                temporibus animi sapiente eligendi! Deleniti minima velit recusandae iure.
            </p>
        ...
        >
            ...
            <p class="mt-2 text-gray-500">
                Fugiat odit alias, eaque optio quas nobis minima reiciendis voluptate dolorem nisi facere debitis ea
                laboriosam vitae omnis ut voluptatum eos. Fugiat?
            </p>
