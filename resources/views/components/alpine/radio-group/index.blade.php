...
>
    ...
    <div class="mt-4 space-y-2">
        ...
        >
            ...
            <span class="ml-3">
                <!-- Primary Label -->
                <p :id="$id('radio-option-label')">Laravel</p>
        ...
        >
            ...
            <span class="ml-3">
                <!-- Primary Label -->
                <p :id="$id('radio-option-label')">Rails</p>

                <!-- Secondary Information -->
                <span :id="$id('radio-option-description')" class="mt-2 text-sm">A Ruby framework built by DHH</span>
            </span>
        </div>
        ...
        >
            ...
            <span class="ml-3">
                <!-- Primary Label -->
                <p :id="$id('radio-option-label')">Phoenix</p>
